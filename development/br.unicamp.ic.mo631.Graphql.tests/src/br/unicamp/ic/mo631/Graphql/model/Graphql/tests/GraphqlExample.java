...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>Graphql</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class GraphqlExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(GraphqlPackage.eNS_URI, 
			 GraphqlPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.graphql"));
				Attribute root = GraphqlFactory.eINSTANCE.createAttribute();
