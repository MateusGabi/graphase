...
import br.unicamp.ic.mo631.Graphql.model.Graphql.impl.GraphqlPackageImpl;
...
public class Generate extends AbstractAcceleoGenerator {
    ...
    public static void main(String[] args) {
    	...
    	EPackage myPack = GraphqlPackageImpl.eINSTANCE;
    	EPackage.Registry.INSTANCE.put(myPack.getNsURI(), myPack);
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(org.eclipse.emf.ecp.view.spi.group.model.VGroupPackage.class)) {
            resourceSet.getPackageRegistry().put(org.eclipse.emf.ecp.view.spi.group.model.VGroupPackage.eINSTANCE.getNsURI(), org.eclipse.emf.ecp.view.spi.group.model.VGroupPackage.eINSTANCE);
        }
